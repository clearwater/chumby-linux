				...
				int enable_present)
{
	...
	HW_LCDIF_CTRL1_SET(BF_LCDIF_CTRL1_BYTE_PACKING_FORMAT(0xF) |
	...
	HW_LCDIF_CTRL_SET(BF_LCDIF_CTRL_WORD_LENGTH(0) | /* 16 bit */
	...
	HW_LCDIF_VDCTRL0_SET(BM_LCDIF_VDCTRL0_VSYNC_POL |
